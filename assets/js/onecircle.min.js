...
d+');">\n<div class="cPHQWG">\n<svg viewBox="0 0 17 17" fill="currentColor">\n<path d="M9.565 8.595l5.829 5.829a.686.686 0 01-.97.97l-5.83-5.83-5.828 5.83a.686.686 0 01-.97-.97l5.829-5.83-5.83-5.828a.686.686 0 11.97-.97l5.83 5.829 5.829-5.83a.686.686 0 01.97.97l-5.83 5.83z"></path>\n</svg>\n</div>\n</div>\n</div>'),c.additionArray.push(d),c.addPicBtn.siblings().addClass("btn-disable"),b.val(""),$(".cPHQWG").unbind("click").bind("click",function(){var e=$(this).parent().css("backgroundImage").replace("url(",
"").replace(")","");c.additionArray.splice($.inArray(e,c.additionArray),1);$(this).parent().parent().remove();0===c.additionArray.length&&c.addPicBtn.siblings().removeClass("btn-disable")})):$.message({title:"\u63d0\u793a",message:"\u8bf7\u8f93\u5165\u6b63\u786e\u7684\u56fe\u7247\u5730\u5740",type:"error"});$(a).html("\u6dfb\u52a0")},doParseLinkFunc:function(a,c){$(a).text("\u89e3\u6790\u4e2d");var b=$(".add-area input").val();checkURL(b)?$.post(gconf.oneaction,{type:"parsemeta",url:b},function(d){if(d.code){var e=
$(".sc-AxjAm.kgcKxQ");e.css("display","block");e.attr("href",b);$(".sc-AxjAm.kgcKxQ .hHnMup").html(d.data);c.additionArray=[];c.additionArray.push(b);c.additionArray.push(stripscript(d.data));$(a).text("\u6dfb\u52a0");c.addLinkBtn.siblings().addClass("btn-disable");$(".sc-AxjAm.sc-AxirZ.ezTcmd").unbind("click").bind("click",function(f){$(".kgcKxQ").css("display","none");f.stopPropagation();c.addLinkBtn.siblings().removeClass("btn-disable");return!1})}else $.message({title:"\u63d0\u793a",message:"\u89e3\u6790\u5931\u8d25",
type:"error"}),console.log(d);$(a).text("\u6dfb\u52a0")}):($.message({title:"\u63d0\u793a",message:"\u8bf7\u8f93\u5165\u6b63\u786e\u7684\u5730\u5740",type:"error"}),$(a).text("\u6dfb\u52a0"))},doParseVideoFunc:function(a,c){a=$(".add-area input");var b=a.val();checkURL(b)?(c.additionArray.push(b),c.showPanel.append('<div class="show-panel-inner"><div class="jLaetV"><div class="hHnMup">'+b+'</div></div>\n<div class="ezTcmd show-close">\n<div class="hyliOy">\n<svg viewBox="0 0 17 17" fill="#ccc">\n<path d="M9.565 8.595l5.829 5.829a.686.686 0 01-.97.97l-5.83-5.83-5.828 5.83a.686.686 0 01-.97-.97l5.829-5.83-5.83-5.828a.686.686 0 11.97-.97l5.83 5.829 5.829-5.83a.686.686 0 01.97.97l-5.83 5.83z"></path>\n</svg>\n</div>\n</div></div>'),
c.addVideoBtn.siblings().addClass("btn-disable"),a.val(""),$(".show-close").unbind("click").bind("click",function(){var d=$(this).siblings().text();c.additionArray.splice($.inArray(d,c.additionArray),1);$(this).parent().remove();0===c.additionArray.length&&c.addVideoBtn.siblings().removeClass("btn-disable")})):$.message({title:"\u63d0\u793a",message:"\u8bf7\u8f93\u5165\u6b63\u786e\u7684\u89c6\u9891\u5730\u5740",type:"error"})},doParseBilibiliFunc:function(a,c){a=$(".add-area input");var b=a.val();
c.additionArray.push(b);c.showPanel.append('<div class="show-panel-inner"><div class="jLaetV"><div class="hHnMup">'+b+'</div></div>\n<div class="ezTcmd show-close">\n<div class="hyliOy">\n<svg viewBox="0 0 17 17" fill="#ccc">\n<path d="M9.565 8.595l5.829 5.829a.686.686 0 01-.97.97l-5.83-5.83-5.828 5.83a.686.686 0 01-.97-.97l5.829-5.83-5.83-5.828a.686.686 0 11.97-.97l5.83 5.829 5.829-5.83a.686.686 0 01.97.97l-5.83 5.83z"></path>\n</svg>\n</div>\n</div></div>');c.addBilibiliBtn.siblings().addClass("btn-disable");
...
(a.addArea.toggle(),a.uploadPic.toggle());a.changeType("default")});$("#addlink,#addvideo,#addbilibili").unbind("click").bind("click",function(){a.uploadPic.hide();var b=$(this).data("type");"link"===b?$(".add-area input").attr("placeholder","\u8bf7\u8f93\u5165\u94fe\u63a5"):"video"===b?$(".add-area input").attr("placeholder","\u8bf7\u8f93\u5165\u89c6\u9891\u94fe\u63a5"):"bilibili"===b&&$(".add-area input").attr("placeholder","\u8bf7\u8f93\u5165bv\u53f7");a.nowtype!==b?a.addArea.show():a.addArea.toggle();
...
userMsg.eventInit()},userCenterInit:function(){userCenter.persenalInit()},hightInit:function(){var a=$("pre");0<a.length&&(a.addClass("line-numbers").css("white-space","pre-wrap"),window.onload=function(){a.before('<div class="pre-mac"><span></span><span></span><span></span></div>')});Prism.highlightAll()},annouceInit:function(){var a=$("#liveToast"),c=OneLocalStorage.get("one_toast");0<a.length&&!c&&(a.toast("show"),a=(new Date).getTime(),OneLocalStorage.set("one_toast","1",a+604800))},pjax_complete:function(){this.init()}},
archiveInit={init:function(){this.funcInit()},funcInit:function(){this.archiveEventInit();this.commentInit();this.fansFuncInit();this.circleFuncInit();this.repostFuncInit();this.archAuthorTabShowInit();this.archAuthorTabsClickInit();this.iasInit();this.lazyloadInit()},postRepostArticle:function(a,c,b,d,e,f){if(0>userId)return $.message({title:"\u63d0\u793a",message:"\u8bf7\u767b\u5f55\u540e\u64cd\u4f5c",type:"error"}),!1;a={title:indexInput.loginUserName+"\u8f6c\u53d1\u4e86"+e.substring(0,20),text:'[repost href="'+
a+'" bannerimg="'+b+'" repousername="'+d+'" repostext="'+e+"\" category='"+f+"']","fields[articleType]":"repost","fields[excerpt]":c,markdown:1,"category[]":1,visibility:"publish",allowComment:1,allowPing:1,allowFeed:1,do:"publish"};postArticle(a,!1)},repostFuncInit:function(){var a=$("#repostComment");$(".share-btn").unbind("click").bind("click",function(c){$("#repostModal").modal("show");$("#repostModal").on("shown.bs.modal",function(){a.focus()})});$("#repostBtn").unbind("click").bind("click",
function(c){c=a.val();var b=a.data("posthref"),d=/src=['"]?([^'"]*)['"]?/i,e=$(".article-content").html().match(/<img.*?(?:>|\/>)/i),f="";e&&0<e.length&&(e=e[0].match(d))&&0<e.length&&(f=e[1]);(d=f.match(d))&&0<d.length&&(f=d[1]);d=a.data("username");e=a.data("excerpt");var g=a.data("category");"undefine"===e&&(e="");archiveInit.postRepostArticle(b,c,f,d,e,g);$("#repostModal").modal("hide")});$(".repost-row a").unbind("cilck").bind("click",function(c){var b=$(this).attr("href");$.pjax({url:b,container:"#pjax-container"});
c.stopPropagation()})},postFansArticle:function(a,c,b,d){$.post(gconf.oneaction,{type:"getfocusmid"},function(e){e?(e=parseInt(e),postArticle({title:indexInput.loginUserName+"\u5173\u6ce8\u4e86\u5708\u53cb"+b,text:'[focususer href="'+a+'" avatar="'+c+'" username="'+b+'" sign="'+d+'" ]',"fields[articleType]":"focususer","fields[excerpt]":"\u5173\u6ce8\u4e86\u5708\u53cb"+b,markdown:1,"category[]":e,visibility:"publish",allowComment:1,allowPing:1,allowFeed:1,do:"publish"},!1)):console.log(e)})},fansFuncInit:function(){var a=
this;$(".fan-event").unbind("click").bind("click",function(c){if(0<userId){c=parseInt($(this).data("authorid"));var b="\u5173\u6ce8"===$.trim($(this).text())?"follow":"unfollow";if(parseInt(userId)===c)$.message({title:"\u63d0\u793a",message:"\u81ea\u5df1\u4e0d\u80fd\u5173\u6ce8\u81ea\u5df1\uff01",type:"warning"});else{$(this).attr("disabled",!0);var d=this;$.post(gconf.index,{followuser:1,follow:b,uid:userId,fid:c},function(e){if(e)if("unfollow"===b)$(d).text("\u5173\u6ce8"),$(d).addClass("fans"),
$(d).removeClass("fansed");else if($(d).text("\u5df2\u5173\u6ce8"),$(d).addClass("fansed"),$(d).removeClass("fans"),.3>=Math.random()){if($(d).attr("data-author_page")){e=$(d).parent().siblings().data("authorhref");var f=$(".author-avatar").attr("src");var g=$(".author_page-name").text();var h=$(".author-sign").text()}else h=$(d).parent().siblings(),e=h.attr("href"),f=h.children("img").attr("src"),g=h.children("div").children(".oDrAC").text(),h=h.children("div").children(".ezzhLs").text();a.postFansArticle(e,
f,g,h)}$(d).attr("disabled",!1)})}}else $.message({title:"\u63d0\u793a",message:"\u6ca1\u6709\u767b\u5f55\uff01",type:"warning"})})},circleFuncInit:function(){$(".circle-event").unbind("click").bind("click",function(a){if(0<userId){a=parseInt($(this).data("categoryid"));var c="\u52a0\u5165"===$.trim($(this).text())?"follow":"unfollow";$(this).attr("disabled",!0);var b=this;$.post(gconf.index,{followcircle:1,follow:c,uid:userId,mid:a},function(d){d&&("unfollow"===c?($(b).text("\u52a0\u5165"),$(b).addClass("fans"),
$(b).removeClass("fansed")):($(b).text("\u5df2\u52a0\u5165"),$(b).addClass("fansed"),$(b).removeClass("fans")));$(b).attr("disabled",!1)})}else $.message({title:"\u63d0\u793a",message:"\u6ca1\u6709\u767b\u5f55\uff01",type:"warning"})})},archAuthorTabShowInit:function(){var a=$(".react-tabs__tab-list"),c=a.find("li:first-child");0<a.length&&setTimeout(function(){var b=a.first().offset().left;b=c.first().offset().left-b;var d=$(".line");d.css({transform:"translateX("+b+"px)"});d.show()},100)},archiveLoadRebindInit:function(){archiveInit.fansFuncInit();
indexInput.articleClickInit();archiveInit.lazyloadInit()},archAuthorTabsClickInit:function(){var a=$(".react-tabs__tab-list");if(0<a.length){var c=a.first().offset().left,b=$(".line");a.children().each(function(d,e){$(e).click(function(f){var g=$(e).data("tabindex");$(this).addClass("react-tabs__tab--selected").siblings().removeClass("react-tabs__tab--selected");b.width($(e).width());f=$(e).offset().left-c;b.css({transform:"translateX("+f+"px)"});$.ajax({url:"?tabindex="+g,method:"get",success:function(h){h=
$.parseHTML(h);try{var k=$(".item-container",h);if(0>=k.length)return $.message({title:"\u901a\u77e5",message:"\u670d\u52a1\u5668\u8fd4\u56de\u9519\u8bef\uff0c\u8bf7\u91cd\u8bd5",type:"error"});var m=k.html();0>=$(".pagination",h).length&&(1===g||2===g)?$(".pagination").css("display","none"):0<$(".pagination",h).length&&(0===g||3===g)&&$(".pagination").css("display","flex");$(".item-container").html(m);var l=$(".archive-content");l.removeClass(function(n,p){return(p.match(/(^|\s)tabindex-\S+/g)||
[]).join("")});l.addClass("tabindex-"+g);archiveInit.archiveLoadRebindInit()}catch(n){console.log(n)}}})})})}},archiveEventInit:function(){$("#agree-btn").on("click",function(){$(this).get(0).disabled=!0;$(this).children().css("fill","rgb(228, 88, 62)");$.ajax({url:gconf.index,type:"post",data:"agree="+$(this).attr("data-cid"),async:!0,timeout:3E4,cache:!1,success:function(a){/\d/.test(a)&&$(".agree-num").html(a)},error:function(){$(this).get(0).disabled=!1}})})},commentInit:function(){function a(){$(".comment-reply a").click(function(){d=
$(this).parent().parent().parent().attr("id")});$("#cancel-comment-reply-link").click(function(){d=""})}var c=$("html,body"),b="",d="";a();var e=$("#comment-form"),f=$(".submit.btn.comment-submit");f.unbind("click").bind("click",function(g){$(this).attr("disabled",!0);e.submit()});e.submit(function(){var g=$(this).serializeArray();g[0].value=safe.stripscript(g[0].value);""===$.trim(g[0].value)?($.message({title:"\u63d0\u793a",message:"\u8bf7\u8f93\u5165\u5185\u5bb9",type:"error"}),f.attr("disabled",
!1)):$.ajax({url:$(this).attr("action"),type:"post",data:g,error:function(){alert("\u63d0\u4ea4\u5931\u8d25\uff0c\u8bf7\u68c0\u67e5\u7f51\u7edc\u5e76\u91cd\u8bd5\u6216\u8005\u8054\u7cfb\u7ba1\u7406\u5458\u3002");f.attr("disabled",!1);return!1},success:function(h){f.attr("disabled",!1);if($(".comment-list",h).length){b=$(".comment-list",h).html().match(/id="?comment-\d+/g).join().match(/\d+/g).sort(function(m,l){return m-l}).pop();$(".page-navigator .prev").length&&""==d&&(b="");d?(h=$("#comment-"+
b,h).hide(),0>=$("#"+d).find(".comment-children").length&&$("#"+d).append("<div class='comment-children'><ol class='comment-list'></ol></div>"),b&&$("#"+d+" .comment-children .comment-list").prepend(h),d=""):(h=$("#comment-"+b,h).hide(),$(".comment-list").length||$(".comment-detail").prepend("<h2 class='comment-num'>0 \u6761\u8bc4\u8bba</h2><ol class='comment-list'></ol>"),$(".comment-list").prepend(h));$("#comment-"+b).fadeIn();var k;$(".comment-num").length?(k=parseInt($(".comment-num").text().match(/\d+/)),
$(".comment-num").html($(".comment-num").html().replace(k,k+1))):0;TypechoComment.cancelReply();$("#textarea").val("");$(".comment-reply a, #cancel-comment-reply-link").unbind("click");a();b?c.animate({scrollTop:$("#comment-"+b).offset().top-50},300):c.animate({scrollTop:$("#comments").offset().top-50},300)}else return alert("\u60a8\u8f93\u5165\u7684\u5185\u5bb9\u4e0d\u7b26\u5408\u89c4\u5219\u6216\u8005\u56de\u590d\u592a\u9891\u7e41\uff0c\u8bf7\u4fee\u6539\u5185\u5bb9\u6216\u8005\u7a0d\u7b49\u7247\u523b\u3002"),
...
function submitForm(a){a=$(a);a.val("\u53d1\u9001\u4e2d...");var c=$("#post-title"),b=$("#text").val(),d=new Date,e=d.getFullYear(),f=d.getMonth()+1;d=d.getDate();e=e+"/"+f+"/"+d;0<b.length&&""!==b&&c.val(b.substring(0,40));if("default"===indexInput.nowtype)0!==b.length&&""!==b||c.val("\u56fe\u6587\u5c0f\u8bb0\u4e8b~"+e),1===indexInput.additionArray.length?(b+="\n\n",indexInput.additionArray.forEach(function(k){b=b+"![]("+k+")"}),b+="\n\n"):1<indexInput.additionArray.length&&(b+="\n[gallery]",indexInput.additionArray.forEach(function(k){b=
