...
a.send("type=amapKey");a.onreadystatechange=function(){if(4===a.readyState&&200===a.status){var c=a.responseText;c=JSON.parse(c);c.status&&c.data.jskey?(localStorage.setItem("amapkey",c.data),AMapLoader.load({key:c.data.jskey,version:"1.4.15",plugins:["AMap.Autocomplete","AMap.Geolocation","AMap.Geocoder","AMap.Marker"]}).then(function(b){oneMap.init(b)}).catch(function(b){console.error(b)})):console.log("\u83b7\u53d6amapJsKey\u5931\u8d25")}}}},restoreFromLocal:function(){var a=localStorage.getItem("address");
if(a){a=JSON.parse(a);var c=document.getElementById("ad-address");if(c){var b=document.getElementById("address-input");b.value=a.name;b.style.width="fit-content";document.getElementById("ad-name").value=a.name;document.getElementById("ad-district").value=a.district;c.value=a.address}}},save2local:function(a,c,b){a=JSON.stringify({name:a,district:c,address:b});localStorage.setItem("address",a)},geolocationInit:function(a){var c=new a.Geolocation({enableHighAccuracy:!0,position:"RB",buttonOffset:new a.Pixel(10,
20),zoomToAccuracy:!0,getCityWhenFail:!0,needAddress:!0});this.geolocation=c;c.getCurrentPosition(function(b,d){if("complete"===b){if(d.status){var e=document.getElementById("address-input");e&&(new a.Autocomplete).search(d.formattedAddress,function(f,g){0<g.count&&(e.value=g.tips[0].name,e.style.width="fit-content",document.getElementById("ad-name").value=g.tips[0].name,document.getElementById("ad-district").value=g.tips[0].district,document.getElementById("ad-address").value=g.tips[0].address,oneMap.save2local(g.tips[0].name,
g.tips[0].district,g.tips[0].address))})}}else $.message({title:"\u5b9a\u4f4d\u5931\u8d25",message:"\u5931\u8d25\u539f\u56e0\u6392\u67e5\u4fe1\u606f:"+d.message,type:"error"})})},autoCompleteInit:function(a){var c=document.getElementById("ad-name");c&&(this.autoComplete=new a.Autocomplete({city:"\u5168\u56fd",input:"address-input"}),this.autoComplete.on("select",function(b){c.value=b.poi.name;document.getElementById("ad-district").value=b.poi.district;document.getElementById("ad-address").value=b.poi.address;
oneMap.save2local(b.poi.name,b.poi.district,b.poi.address)}))},mapContainerInit:function(a,c){this.geocoder&&this.marker||(this.geocoder=new a.Geocoder({}),this.marker=new a.Marker);if(document.getElementById("amap-container")){var b=new a.Map("amap-container",{resizeEnable:!0,zoom:15,mapStyle:"amap://styles/fresh"});if(a=utils.getQueryString("name")){var d=this.marker;this.geocoder.getLocation(district+a,function(e,f){"complete"===e&&f.geocodes.length?(d.setPosition(f.geocodes[0].location),b.add(d),
b.setFitView(d)):console.error("\u6839\u636e\u5730\u5740\u67e5\u8be2\u4f4d\u7f6e\u5931\u8d25")})}else b.addControl(c)}}},userMsg={eventInit:function(){function a(){var f=!0,g=function(){f?(f=!1,b.html("\u3010\u65b0\u6d88\u606f\u3011"+d),e.hide()):(f=!0,b.html("\u3010\u3000\u3000\u3000\u3011"+d),e.show());window._titleMsgTime=setTimeout(function(){g()},600)};g()}function c(){b&&(b.html(d),window.clearTimeout(window._titleMsgTime))}var b=$("title"),d=b.html(),e=$("#msg-tip");this.getUnread(function(f){f.code?
0<f.data.num?a():c():c()});$("#chat-tab").unbind("shown.bs.tab").bind("shown.bs.tab",function(f){userMsg.scrollToBottom()})},getUnread:function(a){""!==userId&&void 0!==userId&&$.post(gconf.index,{handleMsg:1,type:"getUnRead"},function(c){c=JSON.parse(c);if(c.code&&0<c.data.num){var b=$("#my-message");b.html(b.html()+(" ("+c.data.num+")"))}a(c)})},getMsg:function(a,c){$.post(gconf.index,{handleMsg:1,type:"getUserMsg",fid:a},function(b){b=JSON.parse(b);c(b);userMsg.scrollToBottom()})},sendMsg:function(a,
c,b){$.post(gconf.index,{handleMsg:1,type:"sendMsg",to:a,text:c},function(d){d=JSON.parse(d);b(d);userMsg.scrollToBottom()})},gensSenderTemplate:function(a,c){return'<div class="media sender"><div class="media-content"><div class="media-left"><figure class="image is-circle is-32"><img src="'+a.avatar+'" title="gogobody"></figure></div>\n                                            <div class="media-body"><div class="contact-message-item">'+c.text+'</div></div></div>\n                                            <div class="media-right text-xs text-muted">'+
c.datetime+"</div></div>"},gensReceiverTemplate:function(a,c){return'<div class="media receiver"><div class="media-content"><div class="media-left"><figure class="image is-circle is-32"><img src="'+a.avatar+'" title="gogobody"></figure></div>\n                                            <div class="media-body"><div class="contact-message-item">'+c.text+'</div></div></div>\n                                            <div class="media-right text-xs text-muted">'+c.datetime+"</div></div>"},buildChatBox:function(a){userMsg.getMsg(a,
function(c){if(c.code){var b=c.data.receiver,d=c.data.sender,e=$("#chat-tab"),f=$("#contact-message-list");if(b.uid){e.children("a").text(b.name);e.children("a").data("uid",b.uid);var g="";c.data.message.forEach(function(h){g="sender"===h.from?g+userMsg.gensSenderTemplate(d,h):g+userMsg.gensReceiverTemplate(b,h)});f.html(g);e.show();e.children("a").tab("show")}}userMsg.scrollToBottom()})},scrollToBottom:function(){var a=$("#contact-messages");a.scrollTop(a[0].scrollHeight)}},userCenter={persenalInit:function(){var a=
$("#OneCircle"),c=$("#OneCircle button[type='submit']");c.unbind("click").bind("click",function(b){$(this).attr("disabled",!0);a.submit()});a.submit(function(){var b=$(this).serializeArray();$.ajax({url:$(this).attr("action"),type:"post",data:b,error:function(){alert("\u63d0\u4ea4\u5931\u8d25\uff0c\u8bf7\u68c0\u67e5\u7f51\u7edc\u5e76\u91cd\u8bd5\u6216\u8005\u8054\u7cfb\u7ba1\u7406\u5458\u3002");c.attr("disabled",!1);return!1},success:function(d){c.attr("disabled",!1);window.location.reload()}});return!1});
$("#avatar-uploader").show()}},safe={stripscript:function(a){return a.replace(/<script.*?>.*?<\/script>/ig,"")}},floatEle={init:function(){this.fabtns=$("#float_action_buttons");this.backToTopBtn=$("#fabtn_back_to_top");this.toggleSidesBtn=$("#fabtn_toggle_sides");this.readingProgressBar=$("#fabtn_reading_progress_bar");this.readingProgressDetails=$("#fabtn_reading_progress_details");this.goToComment=$("#fabtn_go_to_comment");this.isScrolling=!1;this.eventInit();this.changefabtnDisplayStatus()},eventInit:function(){var a=
this;this.backToTopBtn.on("click",function(){floatEle.isScrolling||(floatEle.isScrolling=!0,setTimeout(function(){floatEle.isScrolling=!1},600),$("body,html").animate({scrollTop:0},600))});0<$("#comment").length?$("#fabtn_go_to_comment").removeClass("d-none"):$("#fabtn_go_to_comment").addClass("d-none");this.goToComment.on("click",function(){gotoHash("#comment",600);$("#post_comment_content").focus()});"left"===localStorage.Argon_fabs_Floating_Status&&this.fabtns.addClass("fabtns-float-left");this.toggleSidesBtn.on("click",
function(){a.fabtns.addClass("fabtns-unloaded");setTimeout(function(){a.fabtns.toggleClass("fabtns-float-left");a.fabtns.hasClass("fabtns-float-left")?localStorage.Argon_fabs_Floating_Status="left":localStorage.Argon_fabs_Floating_Status="right";a.fabtns.removeClass("fabtns-unloaded");a.hideAlltoolTip()},300)});this.fabtns.removeClass("fabtns-unloaded")},changefabtnDisplayStatus:function(){var a=$(window).scrollTop()/Math.max($(document).height()-$(window).height(),.01);this.readingProgressDetails.html((100*
a).toFixed(0)+"%");this.readingProgressBar.css("width",(100*a).toFixed(0)+"%");400<=$(window).scrollTop()||.5<=a?this.backToTopBtn.removeClass("fabtn-hidden"):this.backToTopBtn.addClass("fabtn-hidden")},hideAlltoolTip:function(){$("#float_action_buttons button").tooltip("hide")}},blog={init:function(){this.init_load_more()},pjax_complete:function(){this.init_load_more()},eventInit:function(){},init_load_more:function(){var a=$(".j-loadmore a");a.attr("data-href",a.attr("href"));a.removeAttr("href");
a.on("click",function(){if(!$(this).attr("disabled")){$(this).html("loading...");$(this).attr("disabled",!0);var c=$(this).attr("data-href"),b=this;c&&$.ajax({url:c,type:"get",success:function(d){$(b).removeAttr("disabled");$(b).html("\u67e5\u770b\u66f4\u591a");var e=$(d).find(".article-list:not(.sticky)");$(".j-index-article.article").append(e);(d=$(d).find(".j-loadmore a").attr("href"))?$(b).attr("data-href",d):$(".j-loadmore").remove()}})}})}},utils={getQueryString:function(a){a=a.replace(/[]/,
"[").replace(/[]/,"[").replace(/[]/,"\\]");a=(new RegExp("[\\?&]"+a+"=([^&#]*)")).exec(window.parent.location.href);return null==a?"":decodeURI(a[1])},debounce:function(a,c,b){function d(){var l=Date.now()-h;l<c&&0<=l?e=setTimeout(d,c-l):(e=null,b||(k=a.apply(g,f),g=f=null))}var e,f,g,h,k;null==c&&(c=100);var m=function(){g=this;f=arguments;h=Date.now();var l=b&&!e;e||(e=setTimeout(d,c));l&&(k=a.apply(g,f),g=f=null);return k};m.clear=function(){e&&(clearTimeout(e),e=null)};m.flush=function(){e&&(k=
a.apply(g,f),g=f=null,clearTimeout(e),e=null)};return m}};$(function(){$(window).unbind("scroll").bind("scroll",function(){floatEle.changefabtnDisplayStatus()});window.onscroll=utils.debounce(function(){floatEle.hideAlltoolTip()},300);indexInput.init();tagsManageInit.init();recommendInit.init();archiveInit.init();floatEle.init();blog.init()});
var pjaxInit=function(){indexInput.pjax_complete();archiveInit.init();recommendInit.pjax_complete();owoInit();tagsManageInit.pjax_complete();oneMap.pjax_complete();blog.pjax_complete();$("article.post")&&Prism.highlightAll()};
