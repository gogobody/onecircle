...
userMsg.eventInit()},userCenterInit:function(){userCenter.persenalInit()},hightInit:function(){var a=$("pre");0<a.length&&(a.addClass("line-numbers").css("white-space","pre-wrap"),window.onload=function(){a.before('<div class="pre-mac"><span></span><span></span><span></span></div>')});Prism.highlightAll()},pjax_complete:function(){this.init()}},archiveInit={init:function(){this.funcInit()},funcInit:function(){this.archiveEventInit();this.commentInit();this.fansFuncInit();this.circleFuncInit();this.repostFuncInit();
this.archAuthorTabShowInit();this.archAuthorTabsClickInit();this.iasInit();this.lazyloadInit()},postRepostArticle:function(a,c,b,d,e,f){if(0>userId)return $.message({title:"\u63d0\u793a",message:"\u8bf7\u767b\u5f55\u540e\u64cd\u4f5c",type:"error"}),!1;a={title:indexInput.loginUserName+"\u8f6c\u53d1\u4e86"+e.substring(0,20),text:'[repost href="'+a+'" bannerimg="'+b+'" repousername="'+d+'" repostext="'+e+"\" category='"+f+"']","fields[articleType]":"repost","fields[excerpt]":c,markdown:1,"category[]":1,
visibility:"publish",allowComment:1,allowPing:1,allowFeed:1,do:"publish"};postArticle(a,!1)},repostFuncInit:function(){var a=$("#repostComment");$(".share-btn").unbind("click").bind("click",function(c){$("#repostModal").modal("show");$("#repostModal").on("shown.bs.modal",function(){a.focus()})});$("#repostBtn").unbind("click").bind("click",function(c){c=a.val();var b=a.data("posthref"),d=/src=['"]?([^'"]*)['"]?/i,e=$(".article-content").html().match(/<img.*?(?:>|\/>)/i),f="";e&&0<e.length&&(e=e[0].match(d))&&
0<e.length&&(f=e[1]);(d=f.match(d))&&0<d.length&&(f=d[1]);d=a.data("username");e=a.data("excerpt");var g=a.data("category");"undefine"===e&&(e="");archiveInit.postRepostArticle(b,c,f,d,e,g);$("#repostModal").modal("hide")});$(".repost-row a").unbind("cilck").bind("click",function(c){var b=$(this).attr("href");$.pjax({url:b,container:"#pjax-container"});c.stopPropagation()})},postFansArticle:function(a,c,b,d){$.post(gconf.oneaction,{type:"getfocusmid"},function(e){e?(e=parseInt(e),postArticle({title:indexInput.loginUserName+
"\u5173\u6ce8\u4e86\u5708\u53cb"+b,text:'[focususer href="'+a+'" avatar="'+c+'" username="'+b+'" sign="'+d+'" ]',"fields[articleType]":"focususer","fields[excerpt]":"\u5173\u6ce8\u4e86\u5708\u53cb"+b,markdown:1,"category[]":e,visibility:"publish",allowComment:1,allowPing:1,allowFeed:1,do:"publish"},!1)):console.log(e)})},fansFuncInit:function(){var a=this;$(".fan-event").unbind("click").bind("click",function(c){if(0<userId){c=parseInt($(this).data("authorid"));var b="\u5173\u6ce8"===$.trim($(this).text())?
"follow":"unfollow";if(parseInt(userId)===c)$.message({title:"\u63d0\u793a",message:"\u81ea\u5df1\u4e0d\u80fd\u5173\u6ce8\u81ea\u5df1\uff01",type:"warning"});else{$(this).attr("disabled",!0);var d=this;$.post(gconf.index,{followuser:1,follow:b,uid:userId,fid:c},function(e){if(e)if("unfollow"===b)$(d).text("\u5173\u6ce8"),$(d).addClass("fans"),$(d).removeClass("fansed");else if($(d).text("\u5df2\u5173\u6ce8"),$(d).addClass("fansed"),$(d).removeClass("fans"),.3>=Math.random()){if($(d).attr("data-author_page")){e=
$(d).parent().siblings().data("authorhref");var f=$(".author-avatar").attr("src");var g=$(".author_page-name").text();var h=$(".author-sign").text()}else h=$(d).parent().siblings(),e=h.attr("href"),f=h.children("img").attr("src"),g=h.children("div").children(".oDrAC").text(),h=h.children("div").children(".ezzhLs").text();a.postFansArticle(e,f,g,h)}$(d).attr("disabled",!1)})}}else $.message({title:"\u63d0\u793a",message:"\u6ca1\u6709\u767b\u5f55\uff01",type:"warning"})})},circleFuncInit:function(){$(".circle-event").unbind("click").bind("click",
function(a){if(0<userId){a=parseInt($(this).data("categoryid"));var c="\u52a0\u5165"===$.trim($(this).text())?"follow":"unfollow";$(this).attr("disabled",!0);var b=this;$.post(gconf.index,{followcircle:1,follow:c,uid:userId,mid:a},function(d){d&&("unfollow"===c?($(b).text("\u52a0\u5165"),$(b).addClass("fans"),$(b).removeClass("fansed")):($(b).text("\u5df2\u52a0\u5165"),$(b).addClass("fansed"),$(b).removeClass("fans")));$(b).attr("disabled",!1)})}else $.message({title:"\u63d0\u793a",message:"\u6ca1\u6709\u767b\u5f55\uff01",
type:"warning"})})},archAuthorTabShowInit:function(){var a=$(".react-tabs__tab-list"),c=a.find("li:first-child");0<a.length&&setTimeout(function(){var b=a.first().offset().left;b=c.first().offset().left-b;var d=$(".line");d.css({transform:"translateX("+b+"px)"});d.show()},100)},archiveLoadRebindInit:function(){archiveInit.fansFuncInit();indexInput.articleClickInit();archiveInit.lazyloadInit()},archAuthorTabsClickInit:function(){var a=$(".react-tabs__tab-list");if(0<a.length){var c=a.first().offset().left,
b=$(".line");a.children().each(function(d,e){$(e).click(function(f){var g=$(e).data("tabindex");$(this).addClass("react-tabs__tab--selected").siblings().removeClass("react-tabs__tab--selected");b.width($(e).width());f=$(e).offset().left-c;b.css({transform:"translateX("+f+"px)"});$.ajax({url:"?tabindex="+g,method:"get",success:function(h){h=$.parseHTML(h);try{var k=$(".item-container",h);if(0>=k.length)return $.message({title:"\u901a\u77e5",message:"\u670d\u52a1\u5668\u8fd4\u56de\u9519\u8bef\uff0c\u8bf7\u91cd\u8bd5",
type:"error"});var m=k.html();0>=$(".pagination",h).length&&(1===g||2===g)?$(".pagination").css("display","none"):0<$(".pagination",h).length&&(0===g||3===g)&&$(".pagination").css("display","flex");$(".item-container").html(m);var l=$(".archive-content");l.removeClass(function(n,p){return(p.match(/(^|\s)tabindex-\S+/g)||[]).join("")});l.addClass("tabindex-"+g);archiveInit.archiveLoadRebindInit()}catch(n){console.log(n)}}})})})}},archiveEventInit:function(){$("#agree-btn").on("click",function(){$(this).get(0).disabled=
!0;$(this).children().css("fill","rgb(228, 88, 62)");$.ajax({url:gconf.index,type:"post",data:"agree="+$(this).attr("data-cid"),async:!0,timeout:3E4,cache:!1,success:function(a){/\d/.test(a)&&$(".agree-num").html(a)},error:function(){$(this).get(0).disabled=!1}})})},commentInit:function(){function a(){$(".comment-reply a").click(function(){d=$(this).parent().parent().parent().attr("id")});$("#cancel-comment-reply-link").click(function(){d=""})}var c=$("html,body"),b="",d="";a();var e=$("#comment-form"),
f=$(".submit.btn.comment-submit");f.unbind("click").bind("click",function(g){$(this).attr("disabled",!0);e.submit()});e.submit(function(){var g=$(this).serializeArray();g[0].value=safe.stripscript(g[0].value);""===$.trim(g[0].value)?($.message({title:"\u63d0\u793a",message:"\u8bf7\u8f93\u5165\u5185\u5bb9",type:"error"}),f.attr("disabled",!1)):$.ajax({url:$(this).attr("action"),type:"post",data:g,error:function(){alert("\u63d0\u4ea4\u5931\u8d25\uff0c\u8bf7\u68c0\u67e5\u7f51\u7edc\u5e76\u91cd\u8bd5\u6216\u8005\u8054\u7cfb\u7ba1\u7406\u5458\u3002");
f.attr("disabled",!1);return!1},success:function(h){f.attr("disabled",!1);if($(".comment-list",h).length){b=$(".comment-list",h).html().match(/id="?comment-\d+/g).join().match(/\d+/g).sort(function(m,l){return m-l}).pop();$(".page-navigator .prev").length&&""==d&&(b="");d?(h=$("#comment-"+b,h).hide(),0>=$("#"+d).find(".comment-children").length&&$("#"+d).append("<div class='comment-children'><ol class='comment-list'></ol></div>"),b&&$("#"+d+" .comment-children .comment-list").prepend(h),d=""):(h=
$("#comment-"+b,h).hide(),$(".comment-list").length||$(".comment-detail").prepend("<h2 class='comment-num'>0 \u6761\u8bc4\u8bba</h2><ol class='comment-list'></ol>"),$(".comment-list").prepend(h));$("#comment-"+b).fadeIn();var k;$(".comment-num").length?(k=parseInt($(".comment-num").text().match(/\d+/)),$(".comment-num").html($(".comment-num").html().replace(k,k+1))):0;TypechoComment.cancelReply();$("#textarea").val("");$(".comment-reply a, #cancel-comment-reply-link").unbind("click");a();b?c.animate({scrollTop:$("#comment-"+
b).offset().top-50},300):c.animate({scrollTop:$("#comments").offset().top-50},300)}else return alert("\u60a8\u8f93\u5165\u7684\u5185\u5bb9\u4e0d\u7b26\u5408\u89c4\u5219\u6216\u8005\u56de\u590d\u592a\u9891\u7e41\uff0c\u8bf7\u4fee\u6539\u5185\u5bb9\u6216\u8005\u7a0d\u7b49\u7247\u523b\u3002"),!1}});return!1})},lazyloadInit:function(){},iasInit:function(){var a=$(".a-pageLink .next");0<a.length||a.attr("style","display:none");a.unbind("click").bind("click",function(){var b=$(this).attr("href"),d=$(".a-pageLink .donut");
void 0!==b&&$.ajax({url:b,type:"get",beforeSend:function(){a.hide();d.fadeIn()},error:function(e){},success:function(e){var f=$(e).find(".post-article");d.hide();$(".list").append(f).fadeIn();e=$(e).find(".a-pageLink .next").attr("href");void 0!==e?(a.attr("href",e),a.fadeIn()):(a.attr("style","display:none"),$(".a-pageLink").append('<a href="javascript:;" rel="nofollow">\u52a0\u8f7d\u5b8c\u6bd5</a>'));archiveInit.archiveLoadRebindInit()}});return!1});var c=$(".a-pageLink .comments-next");0<c.length||
c.attr("style","display:none");c.unbind("click").bind("click",function(){var b=$(this).attr("href"),d=$(".a-pageLink .donut");void 0!==b&&$.ajax({url:b,type:"get",beforeSend:function(){c.hide();d.fadeIn()},error:function(e){},success:function(e){var f=$(e).find(".comment-detail>.comment-list>.comment-list-item");d.hide();$(".comment-detail>.comment-list").append(f).fadeIn();e=$(e).find(".a-pageLink .comments-next").attr("href");void 0!==e?(c.attr("href",e),c.fadeIn()):(c.attr("style","display:none"),
...
tagsManageInit={init:function(){this.circleEditBtn()},circleEditBtn:function(){var a=$(".circle-item .edit-btn button"),c=$("#circle-edit-save"),b=-1;a.unbind("click").bind("click",function(d){b=parseInt($(this).data("categoryid"));d=$(this).data("name");$("#selectCircle").val(d);$("#changeCatagModal").modal("show")});c.unbind("click").bind("click",function(d){0< !b||(d=$("#changeCircle").val(),$.ajax({data:{url:gconf.index,changeCircleCat:1,mid:b,changetomid:d},method:"POST",success:function(e){"success"===
...
(oneMap.autoCompleteInit(oneMap.AMap),oneMap.mapContainerInit(oneMap.AMap,oneMap.geolocation)):$.getScript(oneMap.AMapUrl,function(){oneMap.amapLoadInit()});this.restoreFromLocal()},amapLoadInit:function(){if(!(0>userId)){var a=new XMLHttpRequest;a.open("POST",gconf.oneaction,!0);a.setRequestHeader("Content-type","application/x-www-form-urlencoded");a.send("type=amapKey");a.onreadystatechange=function(){if(4===a.readyState&&200===a.status){var c=a.responseText;c=JSON.parse(c);c.status&&c.data.jskey&&
(localStorage.setItem("amapkey",c.data),AMapLoader.load({key:c.data.jskey,version:"1.4.15",plugins:["AMap.Autocomplete","AMap.Geolocation","AMap.Geocoder","AMap.Marker"]}).then(function(b){oneMap.init(b)}).catch(function(b){console.error(b)}))}}}},restoreFromLocal:function(){var a=localStorage.getItem("address");if(a){a=JSON.parse(a);var c=document.getElementById("ad-address");if(c){var b=document.getElementById("address-input");b.value=a.name;b.style.width="fit-content";document.getElementById("ad-name").value=
a.name;document.getElementById("ad-district").value=a.district;c.value=a.address}}},save2local:function(a,c,b){a=JSON.stringify({name:a,district:c,address:b});localStorage.setItem("address",a)},geolocationInit:function(a){var c=new a.Geolocation({enableHighAccuracy:!0,position:"RB",buttonOffset:new a.Pixel(10,20),zoomToAccuracy:!0,getCityWhenFail:!0,needAddress:!0});this.geolocation=c;c.getCurrentPosition(function(b,d){if("complete"===b){if(d.status){var e=document.getElementById("address-input");
