            ...
            <div class="card user-container">
                <?php if ($this->user->hasLogin()): ?>
                    ...
                    <div class="user-detail">
                        <a href="<?php  $author_url = Typecho_Common::url('/author/'.$this->user->uid,$this->options->rootUrl);echo $author_url?>">
                            <div class="info">
                ...
                <?php $blogInfo = getBlogAdminInfo()?>
                    ...
                    <div class="user-detail user-detail-padding">
                        ...
                        <div class="user-info-fans">
                            <a href="<? $author_url = Typecho_Common::url('/author/'.$blogInfo['uid'],$this->options->rootUrl);_e($author_url)?>"><span style="color: rgb(64, 64, 64);"><? _e(UserFollow::getFollowNum(1));?></span>关注</a>
                            <a href="<?php echo $author_url?>"><span style="color: rgb(64, 64, 64);"><? _e(UserFollow::getOtherFollowNum(1));?></span>被关注</a>
                        </div>
                        <div class="user-info-introduction">
