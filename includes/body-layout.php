...
<div class="container-xl app-container">
    <div id="float_action_buttons" class="float-action-buttons fabtns-unloaded">
        <button id="fabtn_toggle_sides" class="btn btn-icon btn-neutral fabtn shadow-sm" type="button" aria-hidden="true" data-toggle="tooltip" data-placement="left" title="<?php _oc_e('移至另侧', 'argon'); ?>">
        ...
        <button id="fabtn_back_to_top" class="btn btn-icon btn-neutral fabtn shadow-sm" type="button" aria-label="Back To Top" data-toggle="tooltip" data-placement="left" title="<?php _oc_e('回到顶部', 'argon'); ?>">
        ...
        <button id="fabtn_go_to_comment" class="btn btn-icon btn-neutral fabtn shadow-sm d-none" type="button" aria-label="Comment" data-toggle="tooltip" data-placement="left" title="<?php _oc_e('评论', 'argon'); ?>">
        ...
        <button id="fabtn_reading_progress" class="btn btn-icon btn-neutral fabtn shadow-sm" type="button" aria-hidden="true" data-toggle="tooltip" data-placement="left" title="<?php _oc_e('阅读进度', 'argon'); ?>">
