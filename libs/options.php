...
{   $options = Helper::options();
    ...
    $commentUploader = new Typecho_Widget_Helper_Form_Element_Radio('commentUploader',
        array(1 => _t('启用'),
            0 => _t('关闭')),
        0, _t('是否显示评论上传'), '');
    $commentUploader->setAttribute('class', 'j-setting-content j-setting-global');
    $form->addInput($commentUploader);
