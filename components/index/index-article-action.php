...
<div class="content-action">
    ...
    <?php
    $comments_ = utils::getOneCommentIfMore($this->cid);
    foreach ($comments_ as $comments_arr):
        ?>
        <div class="lucky-comment">
            ...
            <div class="index-comment-user"><div class="user-name"><?php _oc_e($comments_arr['author']);?>：</div></div>
            <div class="index-comment-content"><div class="comment-content"><?php _oc_e(comments::parseText($comments_arr['text']));?></div></div>
        </div>
    <?php endforeach;?>
